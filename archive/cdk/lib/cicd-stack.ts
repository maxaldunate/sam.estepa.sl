...
export class CiCdStack extends cdk.Stack {
  constructor(scope: cdk.Construct, id: string, props: CiCdStackProps) {
    ...
    const codebuildProject = new codebuild.PipelineProject(this, "BuildProject", {
      projectName: "EstepaDevServiceCodeBuildProject",
      environment: {
    ...
    Tagger.Tag(codebuildProject, stack);
    ...
    const pipeline = new codepipeline.Pipeline(this, "Pipeline", {
      pipelineName: "EstepaDevPipeline",
    });
    Tagger.Tag(pipeline, stack);
    pipeline.addStage({
      stageName: "Source",
